...
def update_kerning_info(less_path,more_path):
    ...
    left_part_OS2CodePages = 'OS2CodePages:'
    left_part_OS2CodePages_length = len(left_part_OS2CodePages)

    left_part_LangName = 'LangName:'
    ...
    while x_line:
        if left_part_OS2CodePages == x_line[:left_part_OS2CodePages_length]:
